        ...
        >
          ...
          >
            {features.map((feature, index) => (
              ...
              >
                <Card 
                  className="glass-effect hover:shadow-xl transition-all duration-300 h-[340px] bg-gradient-to-br from-primary/5 to-primary/10 backdrop-blur-sm border border-primary/20 dark:border-primary/10 cursor-pointer"
                >
